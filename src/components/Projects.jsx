...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      name: "Gemini Clone",
      desc: "A fully functional AI chatbot interface inspired by Google’s Gemini using React and Gemini API.",
      img: geminiClone,
    ...
    },
    {
      ...
      desc: "Features include user authentication, account management, transaction processing, and a user-friendly interface.",
      img: bankManagement,
    ...
    },
    {
      ...
      desc: "Interactive 3D Solar System visualization built with Three.js.",
      img: solarSystem,
      tags: [
        "Three.js",
        "🌀 Speed Control",
    ...
    {
      name: "Gaming Web",
      desc: "Gaming web application for gamers to purchase and play their favorite games.",
      img: gamingWeb,
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              ...
              className="bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-700 transform-gpu"
            >
              {/* Project Image */}
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between gap-3 mt-4">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg transition-colors duration-300 text-sm sm:text-base transform-gpu"
                    target="_blank"
                  ...
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 border border-cyan-400 hover:bg-gray-700 text-cyan-400 rounded-lg transition-colors duration-300 text-sm sm:text-base transform-gpu"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <FaGithub /> View Code
        ...
        <div className="text-center mt-16" data-aos="fade-up">
          <button className="px-8 py-3 border border-cyan-400 text-cyan-400 rounded-lg hover:bg-cyan-900/30 transition-colors duration-300 transform-gpu">
            View All Projects
          </button>
        </div>
      </div>
